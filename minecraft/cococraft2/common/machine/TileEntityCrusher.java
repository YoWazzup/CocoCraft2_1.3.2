...
import cococraft2.common.blocks.BlockCrusher;
...
public class TileEntityCrusher extends TileEntity implements IInventory, ISidedInventory
{
    ...
    /**
     * Returns true if the crusher is currently burning
     */
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack var1 = CrusherRecipes.crushing().getSmeltingResult(this.crusherItemStacks[0]);
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            {
                crusherItemStacks[2].stackSize += var1.stackSize;
            }
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if(var1 == CocoCraftItems.Ingots.shiftedIndex && par0ItemStack.getItemDamage() == 11)
            {
            	return 1400;
            }
