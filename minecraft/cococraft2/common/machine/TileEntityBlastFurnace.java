...
public class TileEntityBlastFurnace extends TileEntity implements IInventory, ISidedInventory
{
    ...
    {
        return this.blastFurnaceCookTime * par1 / 400;
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.isBurning() && this.canSmelt())
            {
                ...
                if (this.blastFurnaceCookTime == 400)
                {
    ...
    {
        ItemStack result = BlastFurnaceRecipes.blasting().getSmeltingResult(blastFurnaceItemStacks[0]);
        if(result == null) return false;
        if(blastFurnaceItemStacks[2] == null)
        	return true;
        if(blastFurnaceItemStacks[2] != null && blastFurnaceItemStacks[2].itemID == result.itemID&& blastFurnaceItemStacks[2].stackSize < (blastFurnaceItemStacks[2].getMaxStackSize() - (result.stackSize-1))) return true;
        return false;
    }

    /**
     * Turn one item from the blastFurnace source stack into the appropriate smelted item in the blastFurnace result stack
     */
    public void smeltItem()
    {
        ...
        ItemStack itemstack = BlastFurnaceRecipes.blasting().getSmeltingResult(blastFurnaceItemStacks[0]);
        if (blastFurnaceItemStacks[2] == null)
        {
